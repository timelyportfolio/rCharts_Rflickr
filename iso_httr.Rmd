...
Now that we have some interesting photos, we can use [flickr.photos.getExif](https://www.flickr.com/services/api/flickr.photos.getExif.html) for all sorts of meta information.
